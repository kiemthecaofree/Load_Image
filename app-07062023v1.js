...
const appList_Array = [
  ...
  },
  {
    ...
    price: "30K công + Kiếm thêm 80K Từ App",
    hdh: "Android + IOS",
    linkDownload_first: "https://ocbomni.onelink.me/RE8p/dfcmk91a",
    linkDownload_last: "",
    video_link: "https://www.youtube.com/embed/x-l682LRVno",
    require:
    ...
    stop: {
      ...
      notification: {
        ...
        content: `Mình tạm ngưng tặng công 30K kể từ 0h ngày <span class='mau_sac'><strong>${date_string}</strong></span>. Bạn vẫn có thể bấm vào link phía dưới để tải app và tham gia nhận 80K từ chương trình <span class='mau_sac'><strong>Đường Đua Triệu Phú</strong></span> của ngân hàng OCB nhé`,
        // content:
        //   "<span class='mau_sac'><strong>Bạn cần chụp màn hình lại 3 hình ảnh: </strong></span> <ol><li>Hình ảnh nhập mã giới thiệu</li><li>Hình ảnh đăng ký thành công</li><li>Hình ảnh phần chuyển ra 20K thành công</li></ol>",
        color: "#2dd284",
        timeEnd: false,
        buttonContent: "Tải App Ngay",
        isLink: true,
      },
    },
  },
  {
    ...
    stop: {
      ...
      notification: {
        title: "Thông báo quan trọng!",
        content:
          "<b>Sau khi bạn tải app VPBANK xong</b> hoặc <b>trong quá trình đăng ký gặp lỗi</b> bạn cần <span class='mau_sac'><strong>thoát app rồi vào lại link tải app phía dưới</strong></span> để mở app và đăng ký mở tài khoản!",
        color: "#2dd284",
        buttonContent: "Tải App",
        isLink: true,
      },
    },
  },
  ...
  },
  {
    ...
    hdh: "Android",
    linkDownload_first:
      "https://go.isclix.com/deep_link/4665406253457732723/5673481545231285059?",
    linkDownload_last:
      "url=https%3A%2F%2Fplay.google.com%2Fstore%2Fapps%2Fdetails%3Fid%3Dxyz.be.cake",
    video_link: "https://www.youtube.com/embed/dRnrdbbSoYA",
    require: "Từ 18 tuổi trở lên, chưa từng tải app",
    image_link:
      "https://play-lh.googleusercontent.com/RWPd1WdrkKP53RyHHRdmV35eOhxoCHmlujBUIizNf8Gy1pHN4_MVuYao4ncZwFp2Poc=w240-h480-rw",
    description:
      "<li>Điền Username và nhấn tạo link.</li> <li>Nhấn nút tải app để tải app về điện thoại.</li> <li>Thực hiện đăng ký tài khoản CAKE VPBANK online.</li><li>Nhập mã giới thiệu <span class='mau_sac'><strong>AT-00A0J1GY</strong></span> tại mục nhập mã giới thiệu (Nhớ chụp màn hình gửi mình nhé)</li><li>Tiến hành định danh tài khoản online và hoàn tất đăng ký.</li><li>Đăng nhập vào app và ở mục trang chủ chọn <span class='mau_sac'><strong>Tất cả</strong></span> sau đó chọn <span class='mau_sac'><strong>nạp điện thoại</strong></span> và mua thẻ cào 10K hoặc nạp tiền điện thoại 10K nhé.</li><li>Bạn đã hoàn thành các bước rồi nhé, liên hệ mình nhận 30K nha.</li>",
    status: false,
    isUTM: true,
    isUsername: true,
    source: "accesstrade",
  ...
  },
  {
    ...
    hdh: "iPhone IOS",
    linkDownload_first:
      "https://go.isclix.com/deep_link/4665406253457732723/5673484069347447831?",
    linkDownload_last:
      "url=https%3A%2F%2Fapps.apple.com%2Fkn%2Fapp%2Fcake-the-mobile-bank%2Fid1551907051",
    video_link: "https://www.youtube.com/embed/dRnrdbbSoYA",
    require: "Từ 18 tuổi trở lên, chưa từng tải app",
    image_link:
      "https://play-lh.googleusercontent.com/RWPd1WdrkKP53RyHHRdmV35eOhxoCHmlujBUIizNf8Gy1pHN4_MVuYao4ncZwFp2Poc=w240-h480-rw",
  ...
  {
    id: "pinex",
    title: "PINEX Mở Tài Khoản Online",
    price: "40K công + 100K Từ APP",
    hdh: "Android + IOS",
    linkDownload_first: "https://pinex.vn/referral/invite-friend?code=THECAO",
    linkDownload_last: "",
    video_link: "https://www.youtube.com/embed/WY_PfFyOkbQ",
    require: "Từ 18 tuổi trở lên",
    image_link:
      "https://play-lh.googleusercontent.com/x1wHP0LNIEC7IE7dfE3FmlW14mrrl8VNJjTd_Ooy8nc27DGwrpRt7IOpordYrCUgmOt6=w240-h480-rw",
    description:
      "<li>Nhấn nút tải app để tải app về điện thoại.</li> <li>Thực hiện đăng ký tài khoản PineX online.</li><li>Tiến hành định danh tài khoản online và hoàn tất đăng ký.</li><li>Nhập mã giới thiệu <span class='mau_sac'><strong>THECAO</strong></span> tại mục nhập mã giới thiệu.</li><li>Đăng nhập vào app chọn tài sản và nạp 5K hoặc 10K vào tài khoản PineX.</li><li>Tiến hành <span class='mau_sac'><strong>mua cổ phiếu CMWG2213 khối lượng 100 và giá bạn đặt 0.03</strong></span> và đợi khớp lệnh nhé (Bạn có thể tham khảo video hướng dẫn để hiểu rõ hơn phần này)</li><li>Bạn đã hoàn thành các bước rồi nhé, liên hệ mình nhận 40K nha.</li>",
    status: false,
    isUTM: false,
    isUsername: false,
    source: "kiemthecao",
...

  {
    ...
    hdh: "Android + IOS",
    linkDownload_first: "https://cutt.ly/Jwq7gaXO",
    linkDownload_last: "",
