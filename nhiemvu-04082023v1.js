...
const appList_Array = [
  ...
  },
  {
    ...
    hdh: "Android + IOS",
    linkDownload_first: "https://www.youtube.com/@kiemthecao",
    linkDownload_last: "",
    ...
    stop: {
      ...
      notification: {
        ...
        content: `Chương trình đã kết thúc! Cảm ơn các bạn đã tham gia chương trình. Hẹn mọi người ở sự kiện sắp tới.`,
        color: "#2dd284",
        timeEnd: false,
...

  {
    ...
    stop: {
      ...
      notification: {
        title: "Thông báo quan trọng!",
        content:
          "<b>Tạm ngưng tặng công 30K kể từ 0h ngày 4/8/2023</b>. Chương trình đăng ký nhận 20K từ VPBank vẫn diễn ra tới hết ngày 31/8/2023. Tuy nhiên thay vì giao dịch 10K thì chương trình đã thay đổi thể lệ, bạn cần giao dịch từ 50K (Trừ chuyển, nạp tiền) để nhận 20K nhé.",
        color: "#2dd284",
