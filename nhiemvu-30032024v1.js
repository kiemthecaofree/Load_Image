...
const appList_Array = [
  {
    ...
    price: "30-50K tiền công + 3GB Data từ APP",
    require: "Từ 16 tuổi trở lên, chưa từng tải app",
    linkDownload_first: "https://2ly.link/1wwwx",
    linkDownload_last: "",
    video_link: "https://www.youtube.com/embed/VAkc8VttevI",
    image_link:
      "https://play-lh.googleusercontent.com/doVFqWWUzhNZBRJF0tob6VVegWElwyMDNW8MaBi65-evUc5krP0e0gVdCPz7waS7G2M=w240-h480-rw",
    description:
      "<li>Nhấn nút tải app để tải app về điện thoại.</li><li>Thực hiện đăng ký tài khoản MB Bank online.</li><li>Chọn số tài khoản và hoàn tất đăng ký.</li><li>Bạn đã hoàn thành các bước rồi nhé, liên hệ mình nhận thêm 30K - 50K nha.</li>",
    status: true,
    isUTM: false,
    isUsername: false,
    source: "none",
  ...
  },
  {
    ...
    hdh: "Android + IOS",
    linkDownload_first:
      "https://referral.momo.vn/ref/VEVMQ08wMzc4NTQ0MDgxJnJlZmVycmFsVGVsY28=",
    linkDownload_last: "",
