...
const appList_Array = [
  {
    ...
    isStop: true,
    notification:
      "Mình sẽ tiếp tục triển khai tặng công 30K lại vào ngày 1/6/2023. Hiện tại, bạn vẫn có thể tải app và tham gia làm nhiệm vụ nhận 80K miễn phí từ OCB nhé! Cảm ơn bạn.",
  },
  {
    id: "acbone_android",
    ...
    isUsername: true,
    isStop: true,
    notification: "Chiến dịch đang tạm ngưng, bạn quay lại sau nhé! Cảm ơn bạn",
  },
  {
    id: "acbone_ios",
    title: "ACB ONE Mở Tài Khoản Online",
...

  {
    ...
    price: "20K công + 20K từ APP",
    hdh: "Android + IOS",
    linkDownload_first: "https://vpo.page.link/hA6hcLnH5yrngphS6",
    linkDownload_last: "",
    video_link: "https://www.youtube.com/embed/Q0j2KHxalEc",
    require: "Từ 18 tuổi trở lên, chưa từng tải app",
    image_link:
      "https://play-lh.googleusercontent.com/u9fUwltudW3eSwh0RddQsiAzTpXWRtD8TS0TCC3s--NgUej28iWoCikXCrFLd89YgxHX=w240-h480-rw",
    description:
      "<li>Điền Username và nhấn tạo link.</li> <li>Nhấn nút tải app để tải app về điện thoại.</li> <li>Thực hiện đăng ký tài khoản VPBANK online.</li><li>Bỏ qua tất cả các mục nhập mã giới thiệu.</li><li>Tiến hành định danh tài khoản online và hoàn tất đăng ký.</li><li>Đăng nhập vào app và mua thẻ cào 10K hoặc nạp tiền điện thoại 10K nhé.</li><li>Bạn đã hoàn thành các bước rồi nhé, nhận ngay 20K sau khi đăng ký thành công và liên hệ mình nhận 20K nha.</li>",
    status: true,
    isUTM: true,
    source: "kiemthecao",
    isUsername: false,
...
btn_success.forEach((btn) => {
  btn.addEventListener("click", () => {
    ...
    if (app) {
          if (app.isStop) {
            alert_message.textContent = app.notification;
            alert_title.textContent = "Thất bại!";
            alert_img.src = image_err;
            message_top.style.backgroundColor = "#d85261";
            alert_button_success.textContent = "Tạo lại Username!!!";
  ...
  download_no_username_list.forEach(element => {
    element.addEventListener("click", (e) => {
      ...
      if (app.isStop){
        ...
        alert_img.src = image_err;
        message_top.style.backgroundColor = "#d85261";
        // alert_button_success.textContent = "Quay lại sau!";
         alert_button_success.textContent = "";
        alert_button_success.insertAdjacentHTML(
          "beforeEnd",
          `<a href = ${app.linkDownload_first} target="_blank">Vẫn Tải App</a>`
        );
        message_container.classList.remove("hidden_div");
        e.preventDefault();
      } 
