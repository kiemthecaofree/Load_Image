...
const appList_Array = [
  {
    ...
    isStop: false,
    notification:
      "Chiến dịch dự kiến chạy vào 0h0p 1/5/2023, bạn nhắn vào Zalo mình ở trên để đăng ký tham gia và quay lại sau nhé! Cảm ơn bạn.",
  },
  {
    id: "acbone_android",
