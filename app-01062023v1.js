...
const appList_Array = [
  {
    ...
    stop: {
      ...
      notification: {
        ...
        content:
          "<span class='mau_sac'><strong>Bạn cần chụp màn hình lại 3 hình ảnh: </strong></span> <ol style='text-align: left'><li>Hình ảnh nhập mã giới thiệu</li><li>Hình ảnh đăng ký thành công</li><li>Hình ảnh phần chuyển ra 20K thành công</li></ol>",
        color: "#2dd284",
        timeEnd: false,
  ...
  },
  {
    ...
    stop: {
      ...
      notification: {
        title: "Thông báo quan trọng!",
        content:
          "Sau khi bạn tải app VPBANK xong hoặc trong quá trình đăng ký gặp lỗi bạn cần vào lại link tải app phía dưới để mở app và đăng ký mở tài khoản!",
        color: "#2dd284",
