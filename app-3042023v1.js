...
const appList_Array = [
  {
    ...
    require:
      "Từ 18 tuổi trở lên, <span class='mau_sac'><strong>chỉ nhận đăng ký mới từ 0h ngày 1/5. Số lượng có hạn, bạn nhấn vào Zalo phía trên để đăng ký tham gia và nhận hướng dẫn nhé!</strong></span>",
    image_link:
      "https://play-lh.googleusercontent.com/AUZSfk4Zv0Y1QTwbPfjZkJKwWDMW7g9koW-CaxBgkkIKuVJZYZDDL8iizRKTvq-V6-o=w240-h480-rw",
    description:
      "<li>Nhấn nút tải app để tải app OCB OMNI về điện thoại.</li> <li>Thực hiện đăng ký tài khoản OCB OMNI online.</li><li>Lưu ý, phần nhập mã giới thiệu nếu bạn nhấn vào mà không thể điền được là hợp lệ (Bạn nên xem video để hiểu rõ hơn nhé).</li><li>Tiến hành định danh tài khoản, chọn số tài khoản.</li><li>Đăng nhập vào app OCB OMNI.</li><li>Chuyển tiền vào tài khoản OCB của bạn 20K sau đó chuyển ra ngân hàng khác 20K.</li><li>Bạn đã hoàn thành các bước rồi nhé, liên hệ mình nhận 30K và xem video kiếm thêm 80K từ app nhé.</li>",
    status: true,
    isUTM: true,
    isUsername: false,
    source: "kiemthecao",
    isStop: true,
    notification:
      "Chiến dịch dự kiến chạy vào 0h0p 1/05/2023, bạn nhắn vào Zalo mình ở trên để đăng ký tham gia và quay lại sau nhé! Cảm ơn bạn.",
  },
  {
    id: "acbone_android",
  ...
  },
  {
    ...
    description:
      "<li>Điền Username và nhấn tạo link.</li> <li>Nhấn nút tải app để tải app về điện thoại.</li> <li>Thực hiện đăng ký tài khoản VNPAY online.</li><li>Nhập mã giới thiệu <span class='mau_sac'><strong>AT</strong></span> tại mục nhập mã giới thiệu.</li><li>Tiến hành định danh tài khoản và liên kết tài khoản hoặc thẻ ngân hàng với ví VNPAY. Không chấp nhận liên kết thẻ quốc tế như VISA, Mastercard và JCB.</li><li>Bạn đã hoàn thành các bước rồi nhé, liên hệ mình nhận 30K và đợi 1-3 ngày nhận thêm 500K voucher từ app.</li>",
    status: true,
    isUTM: true,
    source: "accesstrade",
    isUsername: true,
