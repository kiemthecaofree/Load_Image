...
const appList_Array = [
  {
    ...
    hdh: "Android + IOS",
    linkDownload_first: "https://ocbomni.onelink.me/RE8p/10g1q4ex",
    linkDownload_last: "",
    ...
    stop: {
      ...
      notification: {
        ...
        // content: `Mình tạm ngưng tặng công 30K kể từ 0h ngày <span class='mau_sac'><strong>${date_string}</strong></span> và sẽ quay trở lại vào <span class='mau_sac'><strong>0h ngày 1/7/2023</strong></span>. Bạn vẫn có thể bấm vào link phía dưới để tải app và tham gia nhận 80K từ chương trình <span class='mau_sac'><strong>Đường Đua Triệu Phú</strong></span> của ngân hàng OCB nhé`,
        content:
          "<span class='mau_sac'><strong>Bạn cần chụp màn hình lại 3 hình ảnh: </strong></span> <ol><li>Hình ảnh nhập mã giới thiệu</li><li>Hình ảnh đăng ký thành công</li><li>Hình ảnh phần chuyển ra 20K thành công</li></ol> <div class = 'image_small_container'><img class ='one_image_small' src='https://kiemthecaofree.com/ocb-one.png'/> <img class ='one_image_small' src='https://kiemthecaofree.com/ocb-two.png'/> <img class ='one_image_small' src='https://kiemthecaofree.com/ocb-three.png'/></p>",
        color: "#2dd284",
        timeEnd: false,
...

  {
    ...
    hdh: "Android + IOS",
    price: "30K công + 150K Từ App",
    linkDownload_first: "https://tnexcampaign.onelink.me/93RY/jehu9qg1",
    linkDownload_last: "",
    ...
    description:
      "<li>Nhấn nút tải app để tải app về điện thoại Android hoặc IOS (Yêu cầu bắt buộc).</li> <li>Thực hiện đăng ký tài khoản TNEX online.</li><li>Tiến hành định danh tài khoản TNEX.</li><li>Đợi hệ thống phê duyệt tài khoản và bạn đăng nhập sau đó.</li><li>Đăng nhập vào app TNEX và Nhập mã giới thiệu <span class='mau_sac'><strong>0378544081</strong></span> tại mục nhập mã giới thiệu sau đó chọn vào nhận 150K nhé.</li><li>Bạn đã hoàn thành các bước rồi nhé, liên hệ mình nhận 10K (Đợt 1) và hoàn thành nhiệm vụ để nhận 150K từ app (Nhận thêm 20K đợt 2 sau khi bạn nhận 150K từ App).</li>",
    status: true,
    isUTM: true,
    isUsername: false,
    source: "kiemthecao",
...

  {
    ...
    hdh: "Android + IOS",
    linkDownload_first:
      "https://social.zalopay.vn/mega/mapcard/share/v1/jYz348b2Jqo97MT0nMhV4g",
    linkDownload_last: "",
...
window.onload = () => {
  const image_small = document.querySelectorAll(".one_image_small");
